            ...
            $('#kecamatan_tables').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,                
                "sAjaxSource": "{SITE_URL}master/kecamatan/list_table",
                 "sServerMethod": "POST",
                ...
                "aoColumnDefs": [
                    ...
                    {'sWidth': '20%', 'bSortable': false,'aTargets': [1]},
                    {'sWidth': '20%', 'bSortable': false,'aTargets': [2]},
            ...
            jQuery('#kecamatan_tables .dataTables_filter input').addClass("form-control input-medium"); // modify table search input
            jQuery('#kecamatan_tables .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
            ...
            $('body').on('click', '#kecamatan_tables .btn-editable', function() {
                alert('Edit record with id:' + $(this).attr("data-id"));
            });

            $('body').on('click', '#kecamatan_tables .btn-removable', function() {
