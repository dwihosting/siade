            ...
            $('#kabupaten_tables').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,                
                "sAjaxSource": "{SITE_URL}master/kabupaten/list_table",
                 "sServerMethod": "POST",
            ...
            jQuery('#kabupaten_tables .dataTables_filter input').addClass("form-control input-medium"); // modify table search input
            jQuery('#kabupaten_tables .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
            ...
            $('body').on('click', '#kabupaten_tables .btn-editable', function() {
                alert('Edit record with id:' + $(this).attr("data-id"));
            });

            $('body').on('click', '#kabupaten_tables .btn-removable', function() {
