...
class Home extends CI_Controller {
	 ...
	 */
        function __construct() {
            ...
            $status = $this->siade_auth->is_login();
	...
	public function index()
	{
            ...
            $data = array(
                'BASE_URL'      => base_url(),
                'SITE_URL'      => site_url(),
                'TITLE_PAGE'    => 'Dashboard :: Sistem Informasi Administrasi Desa',
            ...
            $data['CONTENT_SECTION']        = $this->parser->parse('dashboard', $data, true);
        ...
        public function login()
        {
            ...
            $data['CONTENT_SECTION'] = $this->parser->parse($this->themes.'/layout/form/login', $data);
	}   
