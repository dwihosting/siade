            ...
            $('#kategori_tables').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,                
                "sAjaxSource": "{SITE_URL}inventaris/kategori/list_table",
                 "sServerMethod": "POST",
            ...
            jQuery('#kategori_tables .dataTables_filter input').addClass("form-control input-medium"); // modify table search input
            jQuery('#kategori_tables .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
            ...
            $('body').on('click', '#kategori_tables .btn-editable', function() {
                alert('Edit record with id:' + $(this).attr("data-id"));
            });

            $('body').on('click', '#kategori_tables .btn-removable', function() {
