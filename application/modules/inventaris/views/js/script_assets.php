            ...
            $('#asset_tables').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,                
                "sAjaxSource": "{SITE_URL}inventaris/assets/list_table",
                 "sServerMethod": "POST",
            ...
            jQuery('#asset_tables .dataTables_filter input').addClass("form-control input-medium"); // modify table search input
            jQuery('#asset_tables .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
            ...
            $('body').on('click', '#asset_tables .btn-editable', function() {
